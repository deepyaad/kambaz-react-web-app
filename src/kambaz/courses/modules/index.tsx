...
export default function Modules() {
    ...
    /* comment out the code below to use redux
    ...
    */
    ...
    return (
        <div>
            ...
            (
                <ModulesControls 
                    setModuleName={setModuleName} moduleName={moduleName}       // addModule={addModule} 
                    addModule={() => {
                        ...
                        <div className="wd-title p-3 ps-2 bg-secondary">
                            ...
                            {isFaculty && (
                                <ModuleControlButtons
                                    moduleId={module._id}       //deleteModule={deleteModule} editModule={editModule}
